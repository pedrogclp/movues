    ...
    <ul>
      <li v-for="(elem, index) in films" :key="index">
        <div class="film">
          <div class="poster">
            <img
              :src="'https://image.tmdb.org/t/p/w400/' + elem.poster_path"
              :alt="elem.title"
            />
          </div>
          <div class="data">
            ...
            <ul class="genre">
              <li v-for="(genre, index_genre) in elem.genres" :key="index_genre">{{ genre.name }}</li>
            </ul>
      ...
      films: [
        {
          ...
          belongs_to_collection: {
            id: 386382,
            name: "Frozen - Colección",
            poster_path: "/zTlLWZxMXNfR2Ciy5JOMLUxp0K2.jpg",
          ...
          status: "Released",
          tagline: "Sé fuerte. Enfréntate a tus miedos.",
          title: "Frozen II",
          video: false,
          vote_average: 7.2,
          vote_count: 4578,
        ...
        },
        {
          ...
          homepage: "http://GreenBookFilm.com",
          id: 490132,
          imdb_id: "tt6966692",
          original_language: "en",
          ...
          popularity: 27.122,
          poster_path: "/od2A7qPtpimcYfqfKXkpHqoKyuS.jpg",
          production_companies: [
            {
              id: 6735,
          ...
          status: "Released",
          tagline: "Inspirada por una amistad verdadera.",
          title: "Green Book",
          video: false,
          vote_average: 8.3,
          vote_count: 6296,
        },
        {
          ...
          belongs_to_collection: {
            ...
            poster_path: "/ui1wBgNNEy8H4S5gmlY1mWgfzbd.jpg",
        ...
        },
        {
          ...
          popularity: 46.497,
          poster_path: "/i3WnZpJkQYXXbSGplEGmyoyeskM.jpg",
          production_companies: [
            {
              id: 6125,
              logo_path: "/tVPmo07IHhBs4HuilrcV0yujsZ9.png",
